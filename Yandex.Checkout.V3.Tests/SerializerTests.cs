            ...
            var json = @"
{
    ...
    ""object"": {
        ...
        ""authorization_details"": {
            ...
            var message = Client.ParseMessage("POST", "application/json", json);
            Assert.AreEqual(Event.PaymentSucceeded, message.Event);
            Assert.AreEqual("notification", message.Type);
            Assert.IsNotNull(message.RawJson);
            Assert.IsNotNull(message.Payment);
            ...
            var json = @"
{
    ...
    ""object"": {
        ...
        ""description"": ""Возврат на сайте""
            ...
            var message = Client.ParseMessage("POST", "application/json", json);
            Assert.AreEqual(Event.RefundSucceeded, message.Event);
            Assert.AreEqual("notification", message.Type);
            Assert.IsNotNull(message.RawJson);
            Assert.IsNotNull(message.Refund);
            ...
            var json = @"
{
    ...
    ""object"": {
        ...
        ""cancellation_details"": {
            ...
            var message = Client.ParseMessage("POST", "application/json", json);
            Assert.AreEqual(Event.PaymentCanceled, message.Event);
            Assert.AreEqual("notification", message.Type);
            Assert.IsNotNull(message.RawJson);
            Assert.IsNotNull(message.Payment);
